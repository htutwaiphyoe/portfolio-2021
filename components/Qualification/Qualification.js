  ...
  const lists = [
    {
      ...
      items: [
        {
          title: "Matriculation",
          subtitle: "High School - MDY",
          year: "2015 - 2016",
        },
        { title: "B.E - CEIT", subtitle: "MTU - MDY", year: "2016 - Present" },
        {
          title: "Certificate - ICS",
          subtitle: "CS50 - Harvard",
          year: "2020",
        },
      ],
    },
        ...
        <div className={`${classes.qualification__tabs}`}>
          {tabs.map((tab, i) => (
            <Tab
              tab={tab}
              key={i}
              activeClass={classes.qualification__active}
            />
          ))}
        </div>
        <div
